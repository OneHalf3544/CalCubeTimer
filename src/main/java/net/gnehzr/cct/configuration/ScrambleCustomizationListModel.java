...
public class ScrambleCustomizationListModel extends DraggableJTableModel implements TableCellRenderer, TableCellEditor, MouseListener {
	...
	public ScrambleCustomizationListModel(Configuration configuration, ScramblePluginManager scramblePluginManager) {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		if(value instanceof PuzzleType) {
			...
			ScrambleSettings v = customization.scramblePluginManager.getScrambleVariation(customization);
			if(column == 0) { //scramble customization
				...
				val = scramblePluginManager.getScrambleVariation(customization).getGeneratorGroup();
...
//		if(scramLength != null) {
			puzzleType.scramblePluginManager.getScrambleVariation(puzzleType).setLength((Integer) scramLength.getValue());
