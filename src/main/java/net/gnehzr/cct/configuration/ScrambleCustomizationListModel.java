...
public class ScrambleCustomizationListModel extends DraggableJTableModel implements TableCellRenderer, TableCellEditor, MouseListener {
	...
	public boolean isRowDeletable(int rowIndex) {
		...
		Collection<String> dbCustoms = profileDao.getSelectedProfile().getPuzzleDatabase().getCustomizations();
		...
		return !dbCustoms.contains(sc.toString()) && (sc.getCustomization() != null || sc.getScramblePlugin() == null);
	}
	...
	private JPanel getCustomizationPanel(ScrambleCustomization custom) {
		...
		if(custom.getCustomization() != null) {
			scrambleVariations = new ScrambleChooserComboBox(false, false, scramblePluginManager, configuration, profileDao);
