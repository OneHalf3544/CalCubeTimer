...
public class ScrambleCustomizationListModel extends DraggableJTableModel implements TableCellRenderer, TableCellEditor, MouseListener {
	...
	public ScrambleCustomizationListModel(Configuration configuration, ScramblePlugin scramblePlugin, ProfileDao profileDao) {
	...
	public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
		if(value instanceof ScrambleCustomization)
			...
			customization = new ScrambleCustomization(configuration, scramblePlugin.getCurrentScrambleCustomization(profileDao.getSelectedProfile()).getScrambleVariation(), "");
	...
	private JPanel getCustomizationPanel(ScrambleCustomization custom) {
		...
		if(custom.getCustomization() != null) {
			scrambleVariations = new ScrambleChooserComboBox(false, false, scramblePlugin, configuration, profileDao);
